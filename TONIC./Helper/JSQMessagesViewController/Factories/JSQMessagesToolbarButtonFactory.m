...
- (UIButton *)defaultSendButtonItem
{
    ...
    [sendButton setTitleColor:[UIColor colorWithRed:0.157 green:0.604 blue:0.161 alpha:1.00]forState:UIControlStateNormal];
    ...
    sendButton.titleLabel.font = font;//self.buttonFont;
