...
- (void) composeView
{
   ...
   [self adjustTextInputHeightForText:@"" animated:NO];
    ...
    lblPlaceholder.text = @"Touch to text";
...
- (void) adjustTextInputHeightForText:(NSString*)text animated:(BOOL)animated
{
   ...
   int h2 = [text sizeForFont:textView.font constrainedToSize:CGSizeMake(textView.frame.size.width - 16, 70.0f) lineBreakMode:NSLineBreakByWordWrapping].height;
