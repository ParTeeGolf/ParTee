...
CGFloat const kRNGridMenuDefaultBlur = 0.7f;
CGFloat const kRNGridMenuDefaultWidth = 300.f;
...
- (instancetype)initWithItems:(NSArray *)items {
    if ((self = [super init])) {
       ...
       _itemFont= [UIFont fontWithName:@"Montserrat-Bold" size:11.f];

        _highlightColor = [UIColor colorWithRed:0.000 green:0.655 blue:0.247 alpha:1.00];
        //[UIColor colorWithRed:.02f green:.549f blue:.961f alpha:1.f];
