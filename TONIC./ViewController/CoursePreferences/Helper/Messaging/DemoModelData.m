...
- (instancetype)init
{
    ...
    if (self) {
      ...
      //      [self loadFakeMessages];
        ...
        self.incomingBubbleImageData = [bubbleFactory incomingMessagesBubbleImageWithColor:[UIColor colorWithRed:0.000 green:0.655 blue:0.176 alpha:1.00]];
    ...
    self.messages = [[NSMutableArray alloc] initWithObjects:
                     [[JSQMessage alloc] initWithSenderId:kJSQDemoAvatarIdSquires
                                        senderDisplayName:@""
                                                     ...
                                                     text:NSLocalizedString(@"Welcome ", nil)],
                     
                     [[JSQMessage alloc] initWithSenderId:kJSQDemoAvatarIdJobs
                                        senderDisplayName:@""
                                                     date:[NSDate distantPast]
                                                     text:NSLocalizedString(@"Nice work Hooda!", nil)],
                     
                   [[JSQMessage alloc] initWithSenderId:kJSQDemoAvatarIdJobs
                                        senderDisplayName:@""
                                                     date:[NSDate date]
                                                     text:NSLocalizedString(@"Keep it up!", nil)],
